...
export function InviteClientModal({ open, onOpenChange }: InviteClientModalProps) {
  ...
  const plans = [
    { value: "pro", label: "Pro Plan - $29/month", description: "Perfect for small businesses" },
    { value: "business", label: "Business Plan - $79/month", description: "Great for growing companies" },
...
You're invited to join ${agencyBranding.name}'s social media management platform! 
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Send an invitation to a new client to join your agency portal</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-border/50">
            <CardHeader className="pb-4">
              ...
              <CardDescription>Choose how to send the invitation</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Generate Link */}
          ...
          <Card className="border-border/50 bg-muted/30">
            <CardHeader className="pb-4">
              ...
              <CardDescription>How the invitation will appear to your client</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="p-4 bg-background rounded-lg border border-border/50">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Social Media Management Platform</p>
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  ...
                  <p>
                    <strong>Subject:</strong> You're invited to join {agencyBranding.name}
                  </p>
                  <p>
                    <strong>Plan:</strong> {plans.find((p) => p.value === selectedPlan)?.label || "No plan selected"}
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-border/50">
          ...
          <Button
            ...
            disabled={!clientName || !clientEmail || !selectedPlan}
            className="flex-1"
            style={{ backgroundColor: agencyBranding.primaryColor }}
          >
