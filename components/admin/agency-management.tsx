...
import { Search, MoreHorizontal, Building2, Users, DollarSign, Eye, Ban, CheckCircle, TrendingUp } from "lucide-react"
...
const agencyClients = {
  "1": [
    { name: "Tech Startup Inc", status: "active", posts: 45, engagement: "4.2%" },
    { name: "Fashion Brand Co", status: "active", posts: 32, engagement: "3.8%" },
    { name: "Food Delivery App", status: "inactive", posts: 12, engagement: "2.1%" },
  ],
  "2": [
    { name: "Local Restaurant", status: "active", posts: 28, engagement: "5.1%" },
    { name: "Fitness Studio", status: "active", posts: 41, engagement: "4.7%" },
  ],
  "3": [
    { name: "E-commerce Store", status: "active", posts: 67, engagement: "6.2%" },
    { name: "SaaS Company", status: "active", posts: 89, engagement: "5.8%" },
    { name: "Consulting Firm", status: "active", posts: 34, engagement: "4.1%" },
  ],
}
...
export function AgencyManagement() {
  ...
  const totalClients = agencies.reduce((sum, agency) => sum + agency.clients, 0)
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage agency accounts and their performance</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {filteredAgencies.map((agency) => (
                <TableRow key={agency.id}>
                  ...
                  <TableCell className="font-medium">{agency.revenue}</TableCell>
                  <TableCell>{getStatusBadge(agency.status)}</TableCell>
                  <TableCell className="text-sm text-muted-foreground">{agency.lastActive}</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => setSelectedAgency(agency.id)}>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>{agencies.find((a) => a.id === selectedAgency)?.name} - Clients</CardTitle>
                <CardDescription>Client accounts managed by this agency</CardDescription>
              </div>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {agencyClients[selectedAgency as keyof typeof agencyClients]?.map((client, index) => (
                  <TableRow key={index}>
